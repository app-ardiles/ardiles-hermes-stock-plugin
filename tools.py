...
def _request_json(
    ...
    headers = {
        ...
        "User-Agent": "Sekar-Ardiles-Stock/2.1",
    }
...
def get_stock_by_location(
    ...
    if not barang or not lokasi:
        return json.dumps(
            {
                "success": False,
                "error": "barang and lokasi are required"
            },
            ensure_ascii=False
        )
...
def get_stock_by_accsys(
    ...
    if not barang or not accsys:
        return json.dumps(
            {
                "success": False,
                "error": "barang and accsys are required"
            },
            ensure_ascii=False
        )
